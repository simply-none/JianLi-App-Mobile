...
// 的 01–21 序号一一对应。2026-09-19 包体优化：噪声少的 12 张已转 WebP（q82，原 JPG
// 由 tool/compress_textures.py --webp 转换后删除）；皮革/瓷砖等高噪点纹理 WebP 不降反升，
// 保留 JPG。扩展名以磁盘实际文件为准（.webp / .jpg 混合）。
//
...
abstract final class CardTextures {
  ...
  static const String heroAsset =
      'assets/images/textures/pexels-tiles-1846980_1920.webp';

  /// 序号 11 的纹理资源（画布待办页统计横幅内「纹理-卡11」节点使用；
  /// 同样单独抽出以便用于 const 上下文）
  static const String texture11 =
      'assets/images/textures/lemoonboots-texture-2351354_1920.webp';

  /// 序号 02 的纹理资源（待办卡片/列表项背景统一使用）jianli-mobile-app\assets\images\textures\lemoonboots-texture-2351354_1920.webp
  static const String texture02 =
      'assets/images/textures/pexels-tiles-1846980_1920.webp';

  /// 序号 01 的纹理资源（待办卡片/列表项背景备选）
  static const String texture01 =
      'assets/images/textures/8926-background-2654852_1920.webp';
  ...
  static const List<CardTexture> all = [
    CardTexture(
      ...
      asset: 'assets/images/textures/8926-background-2654852_1920.webp',
    ),
    CardTexture(
      index: 2,
      label: '02 artsybee-old',
      asset: 'assets/images/textures/artsybee-old-2228749_1920.webp',
    ),
    CardTexture(
      index: 3,
    ...
    CardTexture(
      ...
      asset:
          'assets/images/textures/hgdesigns-watercolor-background-7712381_1920.webp',
    ),
    CardTexture(
      index: 8,
    ...
    CardTexture(
      ...
      asset: 'assets/images/textures/lemoonboots-scrapbook-2239941_1920.webp',
    ),
    CardTexture(
      index: 10,
    ...
    CardTexture(
      ...
      asset: 'assets/images/textures/misku-texture-1033755_1920.webp',
    ),
    CardTexture(
      index: 15,
      label: '15 mrsmary-paper',
      asset: 'assets/images/textures/mrsmary-paper-1914903_1920.webp',
    ),
    CardTexture(
      index: 16,
      label: '16 peggy_marco-texture',
      asset: 'assets/images/textures/peggy_marco-texture-1027711_1920.webp',
    ),
    CardTexture(
      index: 17,
      label: '17 pellissierjp-background',
      asset: 'assets/images/textures/pellissierjp-background-1874541_1920.webp',
    ),
    CardTexture(
      index: 18,
    ...
    CardTexture(
      ...
      asset:
          'assets/images/textures/studiopratisaad0-old-paper-642132_1920.webp',
    ),
    CardTexture(
      index: 21,
      label: '21 tensaisaisai-paper',
      asset: 'assets/images/textures/tensaisaisai-paper-1806467_1920.webp',
    ),
  ];
